...
def metNewton(var, fun, x, k):
    for i in range(k):
        inJac = completoJacobiano(var, fun, x)**-1
...
def metNewtonParada(var, fun, x, tol):
    n = 1000000000
    i = 0
...
for i in range(iter):
    x, error[i] = metNewton(var, fun, x0, itera[i])
